...
function Index() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <Link to="/sign-up">
              <button
                type="button"
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Get started
              </button>
            </Link>
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-xl md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      ...
      {/* Hero Section */}
      <header className="bg-gradient-to-r from-blue-500 to-blue-700 text-white dark:from-blue-700 dark:to-blue-900">
        <div className="container mx-auto px-6 py-20 text-center md:text-left flex flex-col md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <Link to="/sign-up">
              <button className="bg-white text-blue-600 px-8 py-4 rounded-full font-semibold shadow-lg hover:bg-gray-100 transition duration-300 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
                Începe acum
              </button>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-2xl transition-shadow duration-300 dark:bg-gray-700">
              <div className="bg-blue-100 rounded-full p-4 inline-block mb-4 dark:bg-blue-200">
                <svg
      ...
      <section className="bg-white py-20 dark:bg-gray-900">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-blue-50 rounded-xl p-8 dark:bg-gray-800">
              <h3 className="text-5xl font-bold text-blue-600 mb-4 dark:text-blue-400">1M+</h3>
              <p className="text-gray-600 dark:text-gray-300">Tranzacții procesate</p>
            </div>
            <div className="bg-blue-50 rounded-xl p-8 dark:bg-gray-800">
              <h3 className="text-5xl font-bold text-blue-600 mb-4 dark:text-blue-400">99.9%</h3>
              <p className="text-gray-600 dark:text-gray-300">Rata de succes</p>
            </div>
            <div className="bg-blue-50 rounded-xl p-8 dark:bg-gray-800">
              <h3 className="text-5xl font-bold text-blue-600 mb-4 dark:text-blue-400">24/7</h3>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-blue-700 to-blue-500 text-white py-16 dark:from-blue-900 dark:to-blue-700">
        <div className="container mx-auto px-6 text-center">
